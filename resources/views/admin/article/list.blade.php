...
///////////////////////////////////////////////////////
        ...
        $(document).ready(function(){
            ...
            tdTypeOperation.html('<a href="{{ url() }}/admin/article/edit/'+ id +'" style="color: rgb(69, 107, 12);"><i class="fa fa-edit"></i> Ред. </a><br /><a onclick="delArticle(this)" id="'+ id +'" style="cursor: pointer; color: red;" id="delClient"><i class="fa fa-scissors"></i> Удалить</a>');
            });
