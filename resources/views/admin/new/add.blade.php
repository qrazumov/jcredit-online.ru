...
@section('content')
      <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="row">
                <form data-parsley-validate="" id="AddArticle" enctype="multipart/form-data" method="post" action="{{ action('AjaxController@addNew') }}" >
                    ...
                    <div class="box-body pad">
                        ...
                        <textarea id="editorArticle" name="editorArticle" rows="20" cols="80" required="required" data-parsley-minlength="20">Начните ввоодить текст новости...</textarea>
                        <ul class="parsley-errors-list"></ul>
                        <br/>
                        <div class="form-group">
      ...
      $(function () {
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            function stopLoadingAnimation(e) // - функция останавливающая анимацию
            {
              // найдем элемент с изображением загрузки и уберем невидимость:
              var publishAction = $(e.target);
              publishAction.html('Новость опубликована!');
