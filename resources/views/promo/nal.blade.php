...
@section('content')
        <div class="col-lg-12 col-md-12 offerMicro"><!-- Информационный блок обертка -->
            <h1>Заявка на потребительский кредит онлайн</h1>
            <div class="col-lg-12 col-md-12 infoOffer bg-info"><!-- Информационный блок -->
                <div class="row">
                    <div class="col-lg-3 col-md-3">
                        <img src="{{ url() }}/../resources/images/promo/nal_logo.png" align="left" style=" max-height: 150px;" class="img-responsive visible-lg visible-md visible-sm">
                    </div>
                    <div class="col-lg-9 col-md-9">
                        <p class="infoText">На этом сайте Вы можете оставить заявку на потребительский кредит онлайн. Ознакомтесь с кредитами, представленными ниже, выберите наиболее подходящий Вам и нажмите на кнопку "Заполнить заявку". Обратите внимание на то, что при оформлении заявки на потребительский кредит через интернет, процентная ставка как правило <strong>ниже</strong>, чем при обращении в офис банка. Также рекомендуем Вам заполнить заявки в <strong>разные</strong> банки, чтобы увеличить шанс выдачи кредита.</p>
                    </div>
                </div>
            ...
            @foreach($data as $v)
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-4">
                        <a href="{{ url() }}/go/to/{{ $v->id }}/type/n" target="_blank"><img src="{{ url() }}/../resources/images/promo/{{ $v->img }}" class="img-responsive img-thumbnail imgOffer visible-sm visible-md visible-lg"></a>
                    </div>
                    <div class="col-lg-9 col-md-9 col-sm-8">
                        ...
                        <a href="{{ url() }}/go/to/{{ $v->id }}/type/n" target="_blank"><button type="button" class="btn btn-success btn-lg btn-block btnOffer" data-toggle="tooltip" title="">Заполнить заявку</button></a>
                    </div>
                </div>
            </div><!-- 1 предложение -->
            @endforeach
