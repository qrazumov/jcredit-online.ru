        <!-- Modal -->
              <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Заявка на ипотеку онлайн</h4>
              </div>
				                	...
				                	@if($v->spec == '1') 
			                            <tr class="spec-offer-index">
			                                <td>
			                                    ...
			                                    <a href="{{ url() }}/go/to/{{ $v->id }}/type/i" target="_blank"><img class="img-responsive img-thumbnail" src="{{ url() }}/../resources/images/banks/{{ $v->pic_bank }}"></a>
			                                </td>                            
			                                <td>
			                                ...
			                                <td>
			                                    <a href="{{ url() }}/go/to/{{ $v->id }}/type/i" target="_blank" class="btn btn-default btn btn-success btn-block btn-lg btnOffer">Оформить заявку</a>
			                                </td>
			                            </tr>
				                	@else
			                            <tr>
