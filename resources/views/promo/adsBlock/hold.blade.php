        <!-- Modal -->
              <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Заявка на вклад онлайн</h4>
              </div>
				                ...
				                @foreach($data as $v)
				                	@if($v->spec == '1') 
			                            <tr class="spec-offer-index">
			                                ...
			                                <td>
			                                    <a href="{{ url() }}/go/to/{{ $v->id }}/type/h" target="_blank" class="btn btn-default btn btn-success btn-block btn-lg btnOffer">Оформить заявку</a>
			                                </td>
			                            </tr>
				                	@else
			                            <tr>
