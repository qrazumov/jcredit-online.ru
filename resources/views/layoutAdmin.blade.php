      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            <li class="header">КОНСОЛЬ</li>
            <!-- Optionally, you can article icons to the links -->
            <li class="treeview">
              <a href="#"><i class="fa fa-file-text-o"></i> <span>Статьи</span> <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                <li><a href="{{ route('admin::addArticle') }}"><i class="fa fa-edit"></i> <span>Добавить</span></a></li>
                <li><a href="{{ route('admin::listArticle') }}"><i class="fa fa-list-alt"></i> <span>Редактировать</span></a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#"><i class="fa fa-file-text"></i> <span>Новости</span> <i class="fa fa-angle-left pull-right"></i></a>
              <ul class="treeview-menu">
                <li><a href="{{ route('admin::addNew') }}"><i class="fa fa-edit"></i> <span>Добавить</span></a></li>
                <li><a href="{{ route('admin::listNew') }}"><i class="fa fa-list-alt"></i> <span>Редактировать</span></a></li>
              </ul>
            </li>
            <li class="active"><a href="{{ route('admin::category') }}"><i class="fa fa-link"></i> <span>Категории</span></a></li>
            <li><a href="#"><i class="fa fa-link"></i> <span>Найстройки</span></a></li>
