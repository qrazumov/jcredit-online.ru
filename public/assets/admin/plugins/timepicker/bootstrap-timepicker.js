  ...
  Timepicker.prototype = {
    ...
    _init: function() {
      ...
      if (this.$element.parent().hasClass('input-append') || this.$element.parent().hasClass('input-prepend')) {
		if (this.$element.parent('.input-append, .input-prepend').find('.article-on').length) {
			this.$element.parent('.input-append, .input-prepend').find('.article-on').on({
			  'click.timepicker': $.proxy(this.showWidget, this)
			});		
		} else {
			this.$element.closest(this.containerClass).find('.article-on').on({
			  'click.timepicker': $.proxy(this.showWidget, this)
			});		
		}
