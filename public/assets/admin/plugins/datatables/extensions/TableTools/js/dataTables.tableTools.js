...
ZeroClipboard_TableTools.Client.prototype = {
	...
	addEventListener: function(eventName, func) {
		// article user event listener for event
...
TableTools = function( oDT, oOpts )
{
	...
	this.s = {
		...
		"select": {
			...
			/**
			 * Class name to article to selected TR nodes
...
TableTools.prototype = {
	...
	/**
	 * Take the user input arrays and expand them to be fully defined, and then article them to a given
	 * DOM element
	 *  @method  _fnButtonDefinations
	 *  @param {array} buttonSet Set of user defined buttons
	 *  @param {node} wrapper Node to article the created buttons to
	 *  @returns void
	 *  @private 
	 */
		...
		for ( j=0, jLen=aDataIndex.length ; j<jLen ; j++ )
		{
			...
			for ( i=0, iLen=dt.aoColumns.length ; i<iLen ; i++ )
			{
				if ( aColumnsInc[i] )
				{
					...
					/* Bound it and article it to the total data */
					aRow.push( this._fnBoundData( sLoopData, oConfig.sFieldBoundary, regex ) );
				}
			}
